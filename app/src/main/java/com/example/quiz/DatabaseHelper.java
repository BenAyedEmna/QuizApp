...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + QuestionTable.TABLE_NAME + " (" +
...
/*
    public ArrayList<QuestionsList> getAllQuestions() {
        List<QuestionsList> questionsList = new  ArrayList<QuestionsList>();
        ...
        if (c.moveToFirst()){
            do{
                QuestionsList questions = new QuestionList();
                questions.Set
